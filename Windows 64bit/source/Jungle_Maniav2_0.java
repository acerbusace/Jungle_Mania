...
public class Jungle_Maniav2_0 extends PApplet {
...
class Player {
  ...
  Player(PVector newP) {
    ...
    healthDecay = 0.1f*60;
    hunger = 0;
    hungerGain = 0.0002f*60;
    maxStamina = 100;
    stamina = maxStamina;
    staminaRegen = 0.25f*60;
    armor = 10;
  ...
  public void updatePosition(float boostRatio) {
    //saves the players current position
    oldP.x = position.x;
    oldP.y = position.y;
  ...
  //reverts the player back to his previous position
  public void backPosition(int xy) {
  ...
  public void lvlUp(int attribute) {
    ...
    stamina = maxStamina;
    maxHeight += 2.5f;
    healthDecay -= 0.001f*60;
    hungerGain -= 0.0000075f*60;
    aKnockback += 1;
    sKnockback += 0.75f;

    boostTimerDecay -= 0.01f*60;
    reloadTimeDecay += 0.01f*60;
    staminaRegen += 0.025f*60;
...
class Obstacle {
  ...
  public boolean collision(Player ply) {
    if (check) {
...
class Enemy {
  ...
  public float aggroDistance(Player p) {
  ...
  public void aggro(Player p, int s) {
    //chase the player
  ...
  public void takeDamage(Player p) {
    ...
    if (p.attackC) {
      health=health-PApplet.parseInt(p.aDamage);
      KB=true;
      aKB=true;
    } else if (p.attackS) {
      health=health-PApplet.parseInt(p.sDamage);
      KB=true;
      sKB=true;
    }
  }

  public void knockback(Player p) {
...
class EnemyType1 extends Enemy {
  EnemyType1(PVector newP) {
    super(newP);
    size = PApplet.parseInt(random(35, 50));
    enemyType = 0;
...
class EnemyType2 extends Enemy {
  EnemyType2(PVector newP) {
    super(newP);
    size = PApplet.parseInt(random(40, 65));
    enemyType = 1;
...
class EnemyType3 extends Enemy {
  EnemyType3(PVector newP) {
    super(newP);
    size = PApplet.parseInt(random(55, 100));
    enemyType = 2;
    if (size<=65) {
      health=160;
      dmg=70;
...
class EnemyType5 extends Enemy {
  EnemyType5(PVector newP, int type) {
    super(newP);
    if (type==1) {
      size = PApplet.parseInt(random(60, 75));
    } else if (type==2) {
      size = PApplet.parseInt(random(75, 85));
    }
    enemyType = 4;
    if (size<=75) {
      dmg=99;
...
public void setup() {
  ...
  size(PApplet.parseInt(size.x/2), PApplet.parseInt(size.y/2));
...
public void draw() {  
  ...
  if (!paused && !(one.health < 0) && playScreen && !(storyIndex + 0.075f < story.length)) {
  ...
  if (mainScreen) {
    ...
    if (mouseX > width/2 -  width/10/2 && mouseX < width/2 -  width/10/2 + width/10 && mouseY >  height/1.5f -  height/10/2 && mouseY <  height/1.5f -  height/10/2 + height/10) {
      image(startButtonHover, width/2 -  width/10/2, height/1.5f -  height/10/2, width/10, height/10);
    } else {
      image(startButton, width/2 -  width/10/2, height/1.5f -  height/10/2, width/10, height/10);
    }
    if (mouseX > width/2 -  width/10/2 && mouseX < width/2 -  width/10/2 + width/10 && mouseY > height/1.5f -  height/10/2 + height/10 + height/30 && mouseY < height/1.5f -  height/10/2 + height/10 + height/30 + height/10) {
      image(creditButtonHover, width/2 -  width/10/2, height/1.5f -  height/10/2 + height/10 + height/30, width/10, height/10);
    } else {
      image(creditButton, width/2 -  width/10/2, height/1.5f -  height/10/2 + height/10 + height/30, width/10, height/10);
    }
  } 
  //credit screen
    ...
    //draws the correct button images based on if the mouse is hovering over them or not
    if (mouseX > width/2 -  width/10/2 && mouseX < width/2 -  width/10/2 + width/10 && mouseY > height/1.5f -  height/10/2 + height/10 + height/30 && mouseY < height/1.5f -  height/10/2 + height/10 + height/30 + height/10) {
      image(MainMenuButtonHover, width/2 -  width/10/2, height/1.5f -  height/10/2 + height/10 + height/30, width/10, height/10);
    } else {
      image(MainMenuButton, width/2 -  width/10/2, height/1.5f -  height/10/2 + height/10 + height/30, width/10, height/10);
    }
  } 
  //game is being played
    ...
    //story screen
    if (storyIndex + 0.075f < story.length) {
      playSound(storyMusic, 1);

      storyIndex += 0.075f*ratio;
    ...
    //game world
      ...
      if (!paused && !(one.health < 0)) {
        ...
        if (et1.size()<et1Respawn) {
          ...
          if (et1RT>=10) {
            ...
            do {
              ...
              ran_et1_x_1=PApplet.parseInt(random(427 + obs.get(bGPosition).position.x, 3585 + obs.get(bGPosition).position.x ));
              ran_et1_y_1=PApplet.parseInt(random(1118 + obs.get(bGPosition).position.y, 1694 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et1_x_2=PApplet.parseInt(random(164 + obs.get(bGPosition).position.x, 1209 + obs.get(bGPosition).position.x));
              ran_et1_y_2=PApplet.parseInt(random(560 + obs.get(bGPosition).position.y, 1118 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et1_x_3=PApplet.parseInt(random(1840 + obs.get(bGPosition).position.x, 2889 + obs.get(bGPosition).position.x));
              ran_et1_y_3=PApplet.parseInt(random(1694 + obs.get(bGPosition).position.y, 4000 + obs.get(bGPosition).position.y));
            ...
            int ran_et1=PApplet.parseInt(random(1, 5));
        ...
        if (et2.size()<et2Respawn) {
          ...
          if (et2RT>=100) {
            ...
            do {
              ...
              ran_et2_x=PApplet.parseInt(random(440 + obs.get(bGPosition).position.x, 1837 + obs.get(bGPosition).position.x));
              ran_et2_y=PApplet.parseInt(random(2384 + obs.get(bGPosition).position.y, 4357 + obs.get(bGPosition).position.y));
        ...
        if (et3.size()<et3Respawn) {
          ...
          if (et3RT>=100) {
            ...
            do {
              moveOn = true;
              ran_et3_x=PApplet.parseInt(random(1632 + obs.get(bGPosition).position.x, 8000 + obs.get(bGPosition).position.x));
              ran_et3_y=PApplet.parseInt(random(56 + obs.get(bGPosition).position.y, 921 + obs.get(bGPosition).position.y));
        ...
        if (et4.size()<et4Respawn) {
          ...
          if (et4RT>=100) {
            ...
            do {
              ...
              ran_et4_x_1=PApplet.parseInt(random(4976 + obs.get(bGPosition).position.x, 8000 + obs.get(bGPosition).position.x));
              ran_et4_y_1=PApplet.parseInt(random(1128 + obs.get(bGPosition).position.y, 1993 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et4_x_2=PApplet.parseInt(random(6416 + obs.get(bGPosition).position.x, 8000 + obs.get(bGPosition).position.x));
              ran_et4_y_2=PApplet.parseInt(random(1993 + obs.get(bGPosition).position.y, 2874 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et4_x_3=PApplet.parseInt(random(7520 + obs.get(bGPosition).position.x, 8000 + obs.get(bGPosition).position.x));
              ran_et4_y_3=PApplet.parseInt(random(2874 + obs.get(bGPosition).position.y, 3483 + obs.get(bGPosition).position.y));
            ...
            int ran_et4=PApplet.parseInt(random(1, 7));
        ...
        if (et5.size()<et5Respawn) {
          ...
          if (et5RT>=100) {
            ...
            do {
              ...
              ran_et5_x_1=PApplet.parseInt(random(3752 + obs.get(bGPosition).position.x, 5329 + obs.get(bGPosition).position.x));
              ran_et5_y_1=PApplet.parseInt(random(3180 + obs.get(bGPosition).position.y, 4333 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et5_x_2=PApplet.parseInt(random(3760 + obs.get(bGPosition).position.x, 5161 + obs.get(bGPosition).position.x));
              ran_et5_y_2=PApplet.parseInt(random(2476 + obs.get(bGPosition).position.y, 3173 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et5_x_3=PApplet.parseInt(random(6288 + obs.get(bGPosition).position.x, 6685 + obs.get(bGPosition).position.x));
              ran_et5_y_3=PApplet.parseInt(random(2836 + obs.get(bGPosition).position.y, 4349 + obs.get(bGPosition).position.y));
            ...
            do {
              ...
              ran_et5_x_4=PApplet.parseInt(random(6685 + obs.get(bGPosition).position.x, 7686 + obs.get(bGPosition).position.x));
              ran_et5_y_4=PApplet.parseInt(random(3524 + obs.get(bGPosition).position.y, 4349 + obs.get(bGPosition).position.y));
            ...
            int ran_et5=PApplet.parseInt(random(1, 9));
      ...
      if (one.health > 0) {
        image(healthBar[1], 17.5f, 13, (width/5 - 17*2)*(one.health/one.maxHealth), height/10 - 13.25f*2);
      }
      image(healthBar[0], 0, 0, width/5, height/10);

      if (one.hunger > 0) {
        image(healthBar[2], 17.5f, 13 + height/10, (width/5 - 17*2)*one.hunger, height/10 - 13.25f*2);
      }
      image(healthBar[0], 0, height/10, width/5, height/10);

      if (one.stamina > 0) {
        image(healthBar[3], 17.5f, 13 + height/10*2, (width/5 - 17*2)*(one.stamina/one.maxStamina), height/10 - 13.25f*2);
      }
      ...
      text("Claw: " + str(one.aDamage), width/15*4.65f + fontSize*2, height - height/100 - fontSize - height/10/2 - fontSize/2);
      text("Spin: " + str(one.sDamage), width/15*4.65f + fontSize*2, height - height/100 - fontSize - height/10/2 + fontSize/2);
      text("Days Survived: " + str(PApplet.parseInt(timeCount/120)), width - fontSize*6, fontSize);
      ...
      if (currTime - startingTime < 4000) {
        ...
        textAlign(CORNER, CORNER);
        text("The higher your hunger bar, the fast your health depletes", width/5, height/10 + fontSize*1.25f);
      }
      ...
      if (levelUpScreen) {
        //lvl up related text
        text("LEVEL UP!, select which skill to evolve", width/2, height/1.5f - fontSize); 
        text("Speed: " + str(one.speedAttribute), width/4 - fontSize*3, height/1.25f - fontSize);
        text("Power: " + str(one.powerAttribute), width/2 - fontSize*2, height/1.25f - fontSize);
        text("Defence: " + str(one.defenceAttribute), width/1.25f - fontSize*3, height/1.25f - fontSize);

        //draws the correct button images based on if the mouse is hovering over them or not
        if (mouseX > width/4 + fontSize*(2) - fontSize*3 && mouseX < width/4 + fontSize*(2) - fontSize*3 + width/20 && mouseY > height/1.25f - height/15/2 - fontSize && mouseY < height/1.25f - height/15/2 - fontSize + height/15) {
          image(levelUpUIhover, width/4 + fontSize*(2) - fontSize*3, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        } else {
          image(levelUpUI, width/4 + fontSize*(2) - fontSize*3, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        }
        if (mouseX > width/2 + fontSize*(2) - fontSize*2 && mouseX < width/2 + fontSize*(2) - fontSize*2 + width/20 && mouseY > height/1.25f - height/15/2 - fontSize && mouseY < height/1.25f - height/15/2 - fontSize + height/15) {
          image(levelUpUIhover, width/2 + fontSize*(2) - fontSize*2, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        } else {
          image(levelUpUI, width/2 + fontSize*(2) - fontSize*2, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        }
        if (mouseX > width/1.25f + fontSize*(2.5f) - fontSize*3 && mouseX < width/1.23f + fontSize*(2.5f) - fontSize*3 + width/20 && mouseY > height/1.25f - height/15/2 - fontSize && mouseY < height/1.25f - height/15/2 - fontSize + height/15) {
          image(levelUpUIhover, width/1.25f + fontSize*(2.5f) - fontSize*3, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        } else {
          image(levelUpUI, width/1.25f + fontSize*(2.5f) - fontSize*3, height/1.25f - height/15/2 - fontSize, width/20, height/15);
        }
      }
      ...
      if (one.health < 0) {
        ...
        //draws the correct button images based on if the mouse is hovering over them or not
        if (mouseX > width/2 -  width/10/2 && mouseX < width/2 -  width/10/2 + width/10 && mouseY >  height/1.5f -  height/10/2 && mouseY <  height/1.5f -  height/10/2 + height/10) {
          image(playAgainButtonHover, width/2 -  width/10/2, height/1.5f -  height/10/2, width/10, height/10);
        } else {
          image(playAgainButton, width/2 -  width/10/2, height/1.5f -  height/10/2, width/10, height/10);
        }
        if (mouseX > width/2 -  width/10/2 && mouseX < width/2 -  width/10/2 + width/10 && mouseY > height/1.5f -  height/10/2 + height/10 + height/30 && mouseY < height/1.5f -  height/10/2 + height/10 + height/30 + height/10) {
          image(MainMenuButtonHover, width/2 -  width/10/2, height/1.5f -  height/10/2 + height/10 + height/30, width/10, height/10);
        } else {
...
public void reset() {
  ...
  for (int i=0; i<15; i++) {
    ...
    do {
      ...
      ran_et1_x_1=PApplet.parseInt(random(427-3200, 3585-3200 ));
      ran_et1_y_1=PApplet.parseInt(random(1118-1000, 1694-1000));
    ...
    do {
      ...
      ran_et1_x_2=PApplet.parseInt(random(164-3200, 1209-3200));
      ran_et1_y_2=PApplet.parseInt(random(560-1000, 1118-1000));
    ...
    do {
      ...
      ran_et1_x_3=PApplet.parseInt(random(1840-3200, 2889-3200));
      ran_et1_y_3=PApplet.parseInt(random(1694-1000, 4000-1000));
  ...
  for (int i=0; i<20; i++) {
    ...
    do {
      ...
      ran_et2_x=PApplet.parseInt(random(440-3200, 1837-3200));
      ran_et2_y=PApplet.parseInt(random(2384-1000, 4357-1000));
  ...
  for (int i=0; i<25; i++) { 
    ...
    do {
      moveOn = true;
      ran_et3_x=PApplet.parseInt(random(1632-3200, 8000-3200));
      ran_et3_y=PApplet.parseInt(random(56-1000, 921-1000));
  ...
  for (int i=0; i<15; i++) {
    ...
    do {
      ...
      ran_et4_x_1=PApplet.parseInt(random(4976-3200, 8000-3200));
      ran_et4_y_1=PApplet.parseInt(random(1128-1000, 1993-1000));
    ...
    do {
      ...
      ran_et4_x_2=PApplet.parseInt(random(6416-3200, 8000-3200));
      ran_et4_y_2=PApplet.parseInt(random(1993-1000, 2874-1000));
    ...
    do {
      ...
      ran_et4_x_3=PApplet.parseInt(random(7520-3200, 8000-3200));
      ran_et4_y_3=PApplet.parseInt(random(2874-1000, 3483-1000));
  ...
  for (int i=0; i<20; i++) {
    ...
    do {
      ...
      ran_et5_x_1=PApplet.parseInt(random(3752-3200, 5329-3200));
      ran_et5_y_1=PApplet.parseInt(random(3180-1000, 4333-1000));
    ...
    do {
      ...
      ran_et5_x_2=PApplet.parseInt(random(3760-3200, 5161-3200));
      ran_et5_y_2=PApplet.parseInt(random(2476-1000, 3173-1000));
    ...
    do {
      ...
      ran_et5_x_3=PApplet.parseInt(random(6288-3200, 6685-3200));
      ran_et5_y_3=PApplet.parseInt(random(2836-1000, 4349-1000));
    ...
    do {
      ...
      ran_et5_x_4=PApplet.parseInt(random(6685-3200, 7686-3200));
      ran_et5_y_4=PApplet.parseInt(random(3524-1000, 4349-1000));
  ...
  //game is being played
    ...
    if (one.health < 0) {
      ...
      if (levelUpScreen) {
        ...
        else if (mouseX > width/2 + fontSize*(2) - fontSize*2 && mouseX < width/2 + fontSize*(2) - fontSize*2 + width/20 && mouseY > height/1.25f - height/15/2 - fontSize && mouseY < height/1.25f - height/15/2 - fontSize + height/15) {
          playSound(buttonSound, 1);
          one.lvlUp(2);
          levelUpScreen = false;
        }
        //lvl up defence attribute 
        else if (mouseX > width/1.25f + fontSize*(2.5f) - fontSize*3 && mouseX < width/1.23f + fontSize*(2.5f) - fontSize*3 + width/20 && mouseY > height/1.25f - height/15/2 - fontSize && mouseY < height/1.25f - height/15/2 - fontSize + height/15) {
          playSound(buttonSound, 1);
          one.lvlUp(3);
          levelUpScreen = false;
        }
...
public void playSound(AudioPlayer sound, int option) {
...
public void keyReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Jungle_Maniav2_0" };
    if (passedArgs != null) {
